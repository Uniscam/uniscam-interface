...
const BackgroundContainer = styled.div`
  ...
  background-image:
    url(${({ theme }) => theme.isDarkMode ? MountainLeft : FieldLeft }),
  ...
  background-size: auto calc(100% * 0.414814814814815), auto calc(100% * 0.414814814814815), auto calc(100% * 0.425296296296296), 100% 50%, 100% 4px, 100% 50%;
  background-position: top calc(50% - (100vh * 0.410814814814815 / 2)) left, top calc(50% - (100vh * 0.410814814814815 / 2)) right, top center, top center, top calc(50% + 4px) center, bottom center;
...
const Grid = styled.div`
  transform: scaleY(0);
  background-image: linear-gradient(0deg, transparent 24%, rgba(165, 103, 142, 0.5) 25%, #a5678ee6 26%, transparent 27%, transparent 74%, #a5678e80 75%, #a5678ee6 76%, transparent 77%, transparent), linear-gradient(90deg, transparent 24%, #a5678ebf 25%, rgba(0, 6, 59, 0.25) 26%, transparent 27%, transparent 74%, #a5678ebf 75%, rgba(0, 6, 59, 0.25) 76%, transparent 77%, transparent);
